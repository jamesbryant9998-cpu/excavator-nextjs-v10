#!/bin/bash
# excavator-nextjs-v10.zip 自动化部署工具（macOS/Linux 专属）
...
git add .
git commit -m "chore: initial commit of excavator nextjs demo" &> /dev/null
...
if gh repo create excavator-nextjs-v10 --public --source=. --remote=origin --push; then

import { ArrowLeft, Calendar, Tag, ChevronRight, User, ShieldCheck } from 'lucide-react';
...
export async function generateStaticParams() {
  return blogsData.map((article) => ({
    slug: article.slug,
  }));
}

export default function BlogDetailPage({ params }: PageProps) {
  const article = blogsData.find((a) => a.slug === params.slug);
  ...
  // Split content into readable sections based on numbered lists or standard sentences
            ...
            <div className="news-detail-main">
                    ...
                    return (
                      <div key={idx}>
                        <blockquote style={{
                          ...
                          "True machinery reliability is tested under real loading. Our 120-point inspection system guarantees that every excavator engine, hydraulic pump, and track component is verified to 95% new condition."
                        </blockquote>
              ...
              <div style={{ 
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px', alignItems: 'center' }}>
                  ...
                  {['used excavator sourcing', 'heavy equipment inspection', 'importer pricing guide', 'certified pre-owned excavator'].map((kw, kIdx) => (
                    <span 
                      key={kIdx}
                      style={{
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', gap: '20px', alignItems: 'center' }}>
                  <span style={{ color: '#555', fontSize: '0.85rem' }}>EXCAVATOR PRO Insights</span>
                </div>
              </div>
            </div>
